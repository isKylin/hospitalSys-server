...
public interface AppointmentMapper {
     ...
     * @return int
     */
    @Insert("insert into appointment_info(department_id,doctor_id,appointment_count,appointment_registered_count,appointment_data) " +
    ...
    @Update("update appointment_info set department_id = #{departmentId}," +
            ...
            "appointment_data = #{appointmentData} where appointment_id = #{appointmentId}")
